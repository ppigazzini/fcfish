...
| tier | fcfish / Stockfish instructions | IPC (fcfish/SF) |
| --- | --- | --- |
| sse41 | 1.112 | 0.959 |
| avx2 | 0.781 | 0.797 |
...
does not carry to deep search.** On real search work fcfish executes *more*
...
per-ISA hand intrinsics, so fcfish's instructions are individually a shade slower.
