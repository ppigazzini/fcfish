...
#
# Usage (CWD must hold the net: fcfish -> resources/):
#   ../tools/perf_counters.sh <binA> <binB> <rounds> [bench-args...]
#   ../tools/perf_counters.sh ../build/fcfish "$ORACLE"/src/stockfish 8 bench 16 1 13
#   MAX_INSTR_RATIO=1.36 ../tools/perf_counters.sh ../build/fcfish "$ORACLE"/src/stockfish 8 bench 16 1 13
set -u

SELF_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SRC="$SELF_DIR/perf_counters.c"
BIN="${TMPDIR:-/tmp}/fcfish_perf_counters"
