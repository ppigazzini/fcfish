...
//   e.g: perf_counters ../build/fcfish $ORACLE/src/stockfish 8 bench 16 1 13
//   MAX_INSTR_RATIO=1.36 perf_counters ../build/fcfish $ORACLE/src/stockfish 8 bench 16 1 13
