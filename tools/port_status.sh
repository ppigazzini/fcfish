...
ported=$(count PORTED)
# A zfish module fcfish folded into a larger file. Its code IS in the binary, but
...
printf '\n\033[1mfcfish port status\033[0m — target: bit-exact 1:1 Stockfish clone\n\n'
...
printf '  \033[32mFOLDED \033[0m %3d   (merged into a larger fcfish file)\n' "$consolidated"
