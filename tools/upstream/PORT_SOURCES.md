...
| tree | role | commit |
| --- | --- | --- |
| `../Stockfish` | **golden.** Where zfish and ccfish disagree, this wins. | `ebcea3efe9c1b8748e080111c727c33c544d7e06` |
| `../zfish` | **port source.** A Zig port that is already bit-exact; templates, classes and RAII are already gone, which is why ccfish ports from here rather than from C++. | `054299636fd1a6955b88210fc063ff65bc8cba85` |
...
are level. They were not before: ccfish sat nine commits ahead of zfish, none of
