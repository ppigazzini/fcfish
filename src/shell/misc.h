...
#ifndef FCFISH_MISC_H
#define FCFISH_MISC_H

#include <stddef.h>
#include <stdint.h>

// Name this engine, not upstream. fcfish is a port in progress and must not
...
// build (misc.cpp:145); fcfish's build.sh injects no git metadata, so the
