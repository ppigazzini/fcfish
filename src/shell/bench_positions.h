...
// this one is upstream's, that one is fcfish's current anchor. Cutting the
...
#ifndef FCFISH_BENCH_POSITIONS_H
#define FCFISH_BENCH_POSITIONS_H
...
#endif  // FCFISH_BENCH_POSITIONS_H
